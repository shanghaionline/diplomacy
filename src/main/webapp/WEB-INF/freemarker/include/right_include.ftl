<div class="login_right">
  ...
  <div class="interactive">
    ...
    <div class="interactive_links">
      ...
      <a href="${requestContext.contextPath}/message/sendmessage?receiver=admin"><img src="${requestContext.contextPath}/static/images/btn_right_1.gif" alt=""/></a>
      <a href="${requestContext.contextPath}/message/sendmessage?receiver=admin"><img src="${requestContext.contextPath}/static/images/btn_right_2.gif" alt=""/></a>
      <a href="${requestContext.contextPath}/user/get-invite"><img src="${requestContext.contextPath}/static/images/btn_right_3.gif" alt=""/></a>
      <a href="${requestContext.contextPath}/message/inbox/1"><img src="${requestContext.contextPath}/static/images/btn_right_4.gif" alt=""/></a>
